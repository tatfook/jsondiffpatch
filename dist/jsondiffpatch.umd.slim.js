(function (global, factory) {
  ...
  var dmp__namespace = /*#__PURE__*/_interopNamespaceDefault(dmp);
  var chalk__namespace = /*#__PURE__*/_interopNamespaceDefault(chalk);
  ...
  */
  ...
  function getDiffMatchPatch(required) {
    if (!cachedDiffPatch) {
      let instance;
      if (typeof diff_match_patch !== 'undefined') {
        // already loaded, probably a browser
        instance = typeof diff_match_patch === 'function' ? new diff_match_patch() : new diff_match_patch.diff_match_patch();
      } else if (dmp__namespace) {
        try {
          instance = dmp__namespace && new dmp__namespace();
        } catch (err) {
          instance = null;
        }
      }
  ...
  const colors = {
    added: chalk__namespace.green,
    deleted: chalk__namespace.red,
    movedestination: chalk__namespace.gray,
    moved: chalk__namespace.yellow,
    unchanged: chalk__namespace.gray,
